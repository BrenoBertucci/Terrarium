...
return function(game)
  ...
  local file = assert(io.open(out .. "/bridge_cost_probe.log", "w"))
  ...
  local Kit, Mesher = lib.require("BridgeKit"), lib.require("ChunkMesher")
  local function measure(enabled)
    ...
    log(("kit %s  mean %.2f ms a step"):format(enabled and "ON " or "OFF", sum / n * 1000))
  end
