...
set DS_PROBE_DIR=C:\Users\breno\Downloads\GBA\Terrarium\probe_out_voxeltree
set DS_PROBE_TAG=%1
if "%DS_PROBE_TAG%"=="" set DS_PROBE_TAG=vt
if not "%2"=="" set DS_PROBE_QUICK=1
set POKEPORT_DRIVER=mods/TERRARIUM/tests/voxeltree_probe.lua
