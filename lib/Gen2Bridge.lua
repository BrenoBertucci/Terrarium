...
--
-- EARLY FIRST PASS. Terrarium is recommended on Gen 1 only. Gold can
-- boot and draw; most of the fork is unported or untested there. Do not
-- treat a Johto save as a supported playthrough.
--
...
function Bridge.install()
  ...
  print("TERRARIUM: Gen 2 (Gold) is an early first pass. " ..
        "Not recommended -- play Red/Blue/Yellow.")
